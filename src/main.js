...
const dictionaries = {
  "zh-CN": {
    ...
    voice_title: "录音与快捷键", save: "保存设置", recording_mode: "录音方式", push_to_talk: "按住说话，松开识别", toggle_mode: "按一次开始，再按一次结束", hotkey: "全局快捷键", hotkey_hint: "点击后按下新的组合键；注册失败会自动保留旧快捷键。", duration: "最长录音时长（秒）", input_device: "输入设备", mic_test: "麦克风测试", test_500ms: "测试 0.5 秒",
    ...
    general_title: "通用设置", autostart: "登录 Windows 时启动", autostart_hint: "默认开启，应用启动后驻留系统托盘。", auto_update: "启动时检查更新", auto_update_hint: "只检查签名更新，不会自动安装。", language: "界面语言", follow_system: "跟随系统", updates: "软件更新", check_update: "检查更新", install_update: "安装并重启",
  ...
  en: {
    ...
    voice_title: "Recording & hotkey", save: "Save settings", recording_mode: "Recording mode", push_to_talk: "Hold to speak, release to transcribe", toggle_mode: "Press once to start and again to stop", hotkey: "Global hotkey", hotkey_hint: "Click and press a new combination. A failed registration keeps the previous hotkey.", duration: "Maximum recording length (seconds)", input_device: "Input device", mic_test: "Microphone test", test_500ms: "Test for 0.5 seconds",
...
const fields = {
  recordingMode: byId("recording-mode"), hotkey: byId("hotkey-recorder"), maxRecordingSeconds: byId("max-recording-seconds"), inputDevice: byId("input-device"),
